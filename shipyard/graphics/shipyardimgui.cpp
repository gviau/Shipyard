...
shipBool ImGui_ImplWin32_WndProcHandler(HWND hwnd, UINT msg, WPARAM wParam, LPARAM lParam, LRESULT* shipyardMsgHandlingResult)
{
    SHIP_ASSERT(shipyardMsgHandlingResult != nullptr);
